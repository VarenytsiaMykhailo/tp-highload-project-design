...
Для backend сервисов предлагается использовать реализацию на Java-Kotlin стеке, например, с использованием SpringBoot, а взаимодействие между сервисами организовать по REST и gRPC.
